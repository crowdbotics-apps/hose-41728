"""
Django settings for hose_41728 project.
...
WSGI_APPLICATION = 'hose_41728.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hose_41728 API",
    "DESCRIPTION": "API documentation for hose_41728 App",
    "VERSION": "v1",
}
